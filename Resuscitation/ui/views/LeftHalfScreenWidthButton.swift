...
struct LeftHalfScreenWidthButton: View {
    ...
    var body: some View {
        Button(title, action: self.action)
            .frame(width: Self.halfOfScreenWithSpacing, height: height, alignment: .leading)
            .padding(.leading, 12)
    }
...
struct LeftHalfScreenWidthButton_Previews: PreviewProvider {

    static var previews: some View {
        LeftHalfScreenWidthButton("Label") { }
    }
